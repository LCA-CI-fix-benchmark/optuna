...
```
Better Empirical Performance <https://arxiv.org/abs/2304.00000>`_

For multi-objective TPE (MOTPE), please refer to the following papers:
- `Multiobjective Tree-Structured Parzen Estimator for Computationally Expensive Optimization
  Problems <https://dl.acm.org/doi/10.1145/0000000.0000000>`_
- `Multiobjective Tree-Structured Parzen Estimator <https://doi.org/10.0000/jair.1.00000>`_
```
